...
and aexp env exp = match exp with
  ...
  | DictComp (exp1, exp2, comprehensions, loc) ->
    ...
    (TyDict [(ty1, ty2)], env''')
    (* TODO : Not implemented *)
  | GeneratorExp (exp, comprehensions, loc) -> raise NotImplemented
    (* TODO : Not implemented *)
  | Yield (exp_option, loc) -> raise NotImplemented
    (* TODO : Not implemented *)
  | Compare (exp, cmpops, exps, loc) -> raise NotImplemented
    (* TODO : Not implemented *)
  | Call (exp, exps, keywords, exp1_option, exp2_option, loc) -> raise NotImplemented
...
and atarget env target ty =
  match target with
    ...
    | List (exp_list, exp_ctx, loc) ->
      begin
        ...
        match ty with
          ...
          | TyList ty_list -> raise NotImplemented
          | _ -> raise (TypeError "Should be an iterable type")
      end
    ...
    | Attribute (exp, id, exp_ctx, loc) -> raise NotImplemented
    | Subscript (exp, slice, exp_ctx, loc) -> raise NotImplemented
...
let rec astat env stat =
  ...
  match stat with
    ...
    (* TODO *)    
        | With (context_exp, op_vars, body, loc) -> raise NotImplemented
    (* TODO *)    
